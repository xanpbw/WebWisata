...
<style>.art-content .art-postcontent-0 .layout-item-0 { color: #262626; background: #F5F5F3 url('images/a8703.png') no-repeat scroll; padding: 0px;  }
...
<nav class="art-nav">
	...
	<ul class="art-hmenu"><li><a href="user/" class="active">Login</a></li></ul> 
    </nav>
...
<div class="art-sheet clearfix">
    ...
    <div class="art-layout-cell layout-item-0" style="width: 100%" >
        ...
        <p><br></p>
        <p><br></p>
        <h5 style="text-shadow:2px 2px #194B74;">Wisata Bandung City</h5>
        <p style="padding-left: 50px"><br></p>
        <p><br></p>
        <p><br></p>
    </div>
    </div>
